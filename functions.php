...
function theme_scripts(){
    ...
    if ( !is_admin() ) {
        ...
        wp_register_script('js_main', ASSETS_URL . '/assets/js/script.js', false, '1.0', true);
...
function theme_stylesheets(){
	...
	if( $styles_path ) {
		...
		wp_register_style('fonts', ASSETS_URL . '/assets/fonts/stylesheet.css', array(), false, 'all');
		wp_register_style('icomoon', ASSETS_URL . '/assets/icomoon/style.css', array(), false, 'all');
...
add_image_size('foto', 80, 80, false);
add_image_size('icon', 71, 71, false);
